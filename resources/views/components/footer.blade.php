<footer class="bg-dark">
    <div class="container d-flex flex-column align-items-center py-5">
        {{-- <a href="{{ route('homePage') }}"><img src="{{ asset(Lang::locale() === "ar" ? 'imgs/bloodDonerLogoWhite.png' : 'imgs/bloodDonerLogoAsciiWhite.png') }}" alt="bloodDoner Logo" height="40px"></a> --}}
        ...
        {{-- <div class="findUsOnSocialMedia bg-dark d-flex justify-content-end align-items-center">
            <div class="social-btns">
                <a class="btn facebook" href="https://www.facebook.com/bloodDoner" target="_blank">
                ...
                <a class="btn instagram" href="https://www.instagram.com/bloodDoner/" target="_blank">
